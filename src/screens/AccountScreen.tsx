  ...
  return (
    <SafeAreaView edges={['top']} className="flex-1 bg-background">
      <View className="mx-11 flex-1">
        <Text
          className="mb-[18px] mt-[46px] text-center font-notoSansKRBold text-xl text-black"
          style={{
        ...
        <TouchableOpacity
          className="android:elevation-md mt-[76px] flex-row items-center justify-between rounded-xl border border-border bg-white px-3 py-4 shadow-md"
          onPress={handleCheck}>
        ...
        <TouchableOpacity
          className="android:elevation-md mt-[9px] flex-row items-center justify-between rounded-xl border border-border bg-white px-3 py-4 shadow-md"
