...
const TabletMain = ({ navigation }: Props) => {
  return (
    <View className="flex-1 overflow-hidden bg-background">
      ...
      <SafeAreaView className="flex-1 items-center justify-center" edges={['top', 'bottom']}>
        <View className="w-full max-w-[520px] items-center px-[32px]">
          <Text className="text-center font-notoSansKRBold text-[48px] text-black">
            2026 EXPO
          </Text>
          ...
          <Pressable
            className="mt-[72px] h-[68px] w-[288px] items-center justify-center overflow-hidden rounded-[20px]"
            onPress={() => navigation.navigate('TabletLogin')}>
